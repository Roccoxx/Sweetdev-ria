 ...
 */
SweetDevRia.MultiCalendar.prototype.addSingleDateField = function(singleDateFieldId) {
	var cal;
	for (var p=0;p<this.pageCount;++p) {
		cal = this.pages[p];
		cal.addSingleDateField(singleDateFieldId);
	}
	if (cal){
		this.singleDateField = cal.singleDateField;
	} 
};
 ...
 */
SweetDevRia.MultiCalendar.prototype.addExplodedDateField = function(yearFieldId, monthFieldId, dayFieldId) {
	var cal;
	for (var p=0;p<this.pageCount;++p) {
		cal = this.pages[p];
		cal.addExplodedDateField(yearFieldId, monthFieldId, dayFieldId);
	}
	if (cal){
		this.dateDayField = cal.dateDayField; 
		this.dateMonthField = cal.dateMonthField; 
		this.dateYearField = cal.dateYearField;
	} 
};
 ...
 * @param {Date}	the new date to set.
 */
SweetDevRia.MultiCalendar.prototype.setNewDateAndFillDateInFields = function(dat) {
	this.select(dat);
	this.setNewDate(dat);
 ...
 * @param {Sting} a String representing the date to select
 * @param {date} a date representing the selection
 */
SweetDevRia.MultiCalendar.prototype.setValue = SweetDevRia.SimpleCalendar.prototype.setValue;
 ...
 */
SweetDevRia.MultiCalendar.prototype.getErrorMessage = SweetDevRia.SimpleCalendar.prototype.getErrorMessage;
 ...
 * @param {Date} a date representing the selection
 */
SweetDevRia.MultiCalendar.prototype.setSingleValue = SweetDevRia.SimpleCalendar.prototype.setSingleValue;

/**
 * This function handle a date error
 * @param {String} The error message
 */
SweetDevRia.MultiCalendar.prototype.handleError = SweetDevRia.SimpleCalendar.prototype.handleError;
 ...
 * @private
 */
SweetDevRia.MultiCalendar.prototype.checkCalendarDate  = SweetDevRia.SimpleCalendar.prototype.checkCalendarDate;
