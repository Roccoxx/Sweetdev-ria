 ...
 */
SweetDevRia.DateRangeCalendar.prototype.setValue = function(date) {
	this.deselectAll();
	try{
		...
		var message = this.getErrorMessage(e,date);
 ...
 */
SweetDevRia.DateRangeCalendar.prototype.setNewDateAndFillDateInFields = function(dat) {
	this.select(dat);
	if (dat.length){
		// dat's type is Date[] 
